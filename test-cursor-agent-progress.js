...
async function testCursorAgentProgress() {
	...
	try {
		...
		const result = await provider.generateText({
			messages: 'Write a brief summary of what progress tracking means for AI operations.',
...
async function testRecursiveProgress() {
	...
	const progressTracker = provider.createRecursiveProgressTracker(3, 'test-recursive');
